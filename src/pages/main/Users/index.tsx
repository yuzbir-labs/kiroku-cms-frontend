...
const Users: React.FC = () => {
  ...
  const [userTypeFilter, setUserTypeFilter] = useState<UserType | undefined>();
  ...
  const {
    ...
    branch: branchFilter && branchFilter.length > 0 ? branchFilter.join(',') : undefined,
    page: currentPage,
    page_size: pageSize,
  });
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'user_type',
      key: 'user_type',
      render: (type: UserType) => <Tag color={userTypeColors[type]}>{userTypeLabels[type]}</Tag>,
    },
    {
      title: 'Status',
      dataIndex: 'is_active',
    ...
    <div className={styles.container}>
      ...
      <FilterPanel
        filters={{
          ...
          user_type: {
            ...
            onChange: (value) => {
              setUserTypeFilter(value as UserType | undefined);
      ...
      <div className={styles.tableContainer}>
        {isLoading ? (
          ...
          <Table
            columns={columns}
            dataSource={usersResponse?.results || []}
            rowKey="id"
            pagination={{
              current: currentPage,
              pageSize: pageSize,
