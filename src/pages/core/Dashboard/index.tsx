  ...
  return (
    <div className={styles.container}>
          ...
          <Row gutter={16}>
            <Col span={8}>
              <div className={styles.userInfoItem}>
                ...
                <span className={styles.userInfoValue}>{getUserTypeLabel(user.user_type)}</span>
              </div>
            </Col>
            <Col span={8}>
              <div className={styles.userInfoItem}>
            ...
            {user.phone_number && (
              <Col span={8}>
                <div className={styles.userInfoItem}>
                  ...
                  <span className={styles.userInfoValue}>{user.phone_number}</span>
                </div>
              </Col>
            )}
          </Row>
      ...
      {isOrgAdmin && organization && (
        <Card title="Təşkilat Məlumatları" className={styles.organizationCard} loading={orgLoading}>
          <Row gutter={[16, 16]}>
            <Col xs={24} sm={12}>
            ...
            {organization.description && organization.description.trim() && (
              <Col xs={24}>
                <div className={styles.orgInfoItem}>
                  ...
                  <span className={styles.orgInfoValue}>{organization.description}</span>
                </div>
              </Col>
            )}
            {organization.email && organization.email.trim() && (
              <Col xs={24} sm={12}>
                <div className={styles.orgInfoItem}>
                  ...
                  <span className={styles.orgInfoValue}>{organization.email}</span>
                </div>
              </Col>
            )}
            {organization.phone_number && organization.phone_number.trim() && (
              <Col xs={24} sm={12}>
                <div className={styles.orgInfoItem}>
                  ...
                  <span className={styles.orgInfoValue}>{organization.phone_number}</span>
                </div>
              </Col>
            )}
            ...
            {organization.address && organization.address.trim() && (
              <Col xs={24}>
                <div className={styles.orgInfoItem}>
                  ...
                  <span className={styles.orgInfoValue}>{organization.address}</span>
                </div>
              </Col>
            )}
            {(organization.city ||
            ...
            <Col xs={24} sm={12}>
              <div className={styles.orgInfoItem}>
                ...
                <span className={styles.orgInfoValue}>{organization.branch_count}</span>
              </div>
            </Col>
            <Col xs={24} sm={12}>
              <div className={styles.orgInfoItem}>
                <span className={styles.orgInfoLabel}>Ümumi tələbələr:</span>
                <span className={styles.orgInfoValue}>{organization.total_students}</span>
              </div>
            </Col>
            <Col xs={24} sm={12}>
              <div className={styles.orgInfoItem}>
                ...
                <span
                  className={organization.is_active ? styles.statusActive : styles.statusInactive}
                >
