...
const Inquiries: React.FC = () => {
  ...
  const [assigningInquiry, setAssigningInquiry] = useState<Inquiry | null>(
    null
  );
  ...
  const handleEdit = (record: Inquiry) => {
    ...
    form.setFieldsValue({
      ...
      follow_up_date: record.follow_up_date
        ? dayjs(record.follow_up_date)
        : null,
      preferred_start_date: record.preferred_start_date
        ? dayjs(record.preferred_start_date)
        : null,
    });
    setModalVisible(true);
  };
      ...
      >
        <Form form={form} layout="vertical" className={styles.form}>
          ...
          <Form.Item
            ...
            label="Tərcih edilən başlama tarixi"
          >
            <DatePicker style={{ width: '100%' }} format="YYYY-MM-DD" />
          </Form.Item>
